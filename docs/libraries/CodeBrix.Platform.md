...
| AudioPlayerDemo | Song playback in five formats, sound effects, and MIDI through an SFZ instrument | [`samples/CodeBrixPlatform/AudioPlayerDemo`](https://github.com/ellisnet/CodeBrix.Platform/tree/main/samples/CodeBrixPlatform/AudioPlayerDemo) |
...
| Shared sample assets | Audio in five formats, a MIDI file with its SFZ instrument, and short AV1 video clips | [`samples/assets`](https://github.com/ellisnet/CodeBrix.Platform/tree/main/samples/assets) |
